    ...
    return (
        <div>
            <Container sx={{
                ...
                <Tagline><div>Helpful Tips & Tricks to Learn</div></Tagline>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', flexDirection: { xs: 'column', md: 'row' } }}>
                    <Content><div>We are a company who is best known for offering awarding body accredited courses for anyone who wishes to <br /> take their professional life to the next level.</div></Content>
                    <Box >
